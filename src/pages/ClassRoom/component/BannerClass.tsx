...
export default function BannerClass(props : {title :string}) {
  return (
    <div className="w-3/5 flex items-end rounded-md bg-cover bg-center h-60 text-white px-10 object-fill" style={{backgroundImage: 'url(https://gstatic.com/classroom/themes/img_graduation.jpg)'}}>
