          ...
          >
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              ...
              <p className="text-xl text-gray-600">
                Our classroom has many features that will help you to learn
              </p>
            </div>
          </Parallax>
          <Parallax
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Teacher can manage classes, assignments, and grades online
                  without paper
                </p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Teach can make announcements to students and parents
                </p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Teacher can create assignments and grade them online
                </p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Student can track their classwork and homework
                </p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Student and parents can get notifications about assignments
                  and grades
                </p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <p className="text-gray-600 text-center">
                  Teacher can generate reports about students and classes
                </p>
              </div>
            </div>
          </Parallax>
