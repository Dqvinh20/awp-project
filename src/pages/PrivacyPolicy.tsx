...
function PrivacyPolicy() {
  return (
    <div className="antialiased px-6 py-0">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to AWP Classroom.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to AWP Classroom, accessible from{' '}
            <a
              href="https://awp-project.hausuper-s.me"
      ...
      <ul>
        <li>By email: dqvinh20@clc.fitus.edu.vn</li>
      </ul>
    </div>
  );
}
